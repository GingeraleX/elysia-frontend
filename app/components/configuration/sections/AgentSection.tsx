  ...
  return (
    <SettingCard>
      <SettingHeader
        ...
        buttonText={showDocumentation ? "Documentazione" : undefined}
        onClick={
          showDocumentation
            ? () => {
      ...
      <SettingGroup>
        <SettingItem>
          <SettingTitle
            title="Descrizione"
            description="La descrizione del tuo agente."
          />
          <SettingTextarea
        ...
        <SettingItem>
          <SettingTitle
            ...
            description="L'obiettivo finale del tuo agente."
          />
          <SettingTextarea
        ...
        <SettingItem>
          <SettingTitle title="Stile" description="Lo stile del tuo agente." />
          <SettingTextarea
        ...
        {showFeedbackSetting && (
          <SettingItem>
            <SettingTitle
              title="Migliora nel tempo"
              description="Usa automaticamente il modello complesso per tutti i task, salvo quando ci sono abbastanza esempi di feedback positivi già generati dallo stesso modello complesso: in quel caso verrà usato il modello base. Se attivi questa opzione, è consigliato lasciare feedback dopo interazioni riuscite."
            />
            <SettingCheckbox
